...
//         // Base Case1: when start>end
//         if(start>end)
//             return 0;
//         // Base Case2: when mid is last element
//         else if(mid == nums.length-1)
//             return 0;
//         // Base Case3: when mid's next < mid, then mid's next is the pivot, and should return
...
//             else // meaning pivot is in start to mid
...
//         int mid = (end-start)/2 + start;
//         // Base Case1: When mid == target, then return
//         if(nums[mid] == target){
//             return mid;
//         }
//         // Base Case2: When target is completely out of range
